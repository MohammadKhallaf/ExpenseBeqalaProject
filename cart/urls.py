...
urlpatterns = [
    ...
    path('update/cart/<str:pk>/', views.updateCart, name="Update cart"),   # update cart details
    path('delete/cart/<str:pk>/', views.deleteCart, name="delete cart"),   # delete cart details
